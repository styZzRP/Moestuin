    ...
    return (React.createElement("div", { style: S.root },
        ...
        React.createElement("header", { style: S.header, className: "app-header" },
            React.createElement("div", { style: S.brand },
                ...
                React.createElement("div", null,
                    React.createElement("div", { style: S.brandName }, "Brenda's Moestuin"),
        ...
        React.createElement("footer", { style: S.footer, className: "app-footer" },
            React.createElement("button", { style: S.footerBtn, onClick: forceUpdate },
                ...
                " Update"),
            React.createElement("button", { style: S.footerBtn, onClick: exportData },
                React.createElement(Archive, { size: 15 }),
                " Back-up maken"),
            React.createElement("label", { style: { ...S.footerBtn, cursor: "pointer" } },
...
const S = {
    ...
    footerBtn: { display: "inline-flex", alignItems: "center", gap: 6, background: "#fffdf6",
        border: "1px solid #c9ba93", color: "#5d5238", cursor: "pointer", fontSize: 13, fontWeight: 600,
        fontFamily: FONT_BODY, padding: "9px 14px", borderRadius: 10 },
